...
# Layout (per AZ):
#   public   subnet  - NAT gateway and (optional) internet-facing load balancers
#   private  subnet  - EKS worker nodes and pods; egress only through NAT
#   database subnet  - RDS; no route to the internet at all, not even outbound
...
# Database route table has only the implicit local VPC route.
